...
public class ConstructorASTsTiny implements ConstructorASTsTinyConstants {
    ...
    try {
      ...
      switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
        case 43: {
          ...
          {
            if ("" != null)
              return sem.e_indexado(exph, exp);
          }
          break;
        }
        case 59: {
  ...
  private static void jj_la1_init_0() {
    jj_la1_0 = new int[] { 0xa0888e00, 0x0, 0xa0888e00, 0x80808e00, 0x0, 0x0, 0x0, 0x80808e00, 0x80808e00, 0x8e00, 0x0,
        0x5f500000, 0x0, 0x5f500000, 0x200000, 0x80074000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3000, 0x0, 0x80074000, 0x0,
        0x80070000, 0x60000, 0x0, 0x0, 0x4000, 0x0, };
  }

  private static void jj_la1_init_1() {
    jj_la1_1 = new int[] { 0x2000, 0x40, 0x2000, 0x2000, 0x200, 0x400, 0x800, 0x2000, 0x0, 0x0, 0x200, 0x4008, 0x40,
        0x4008, 0x0, 0x10087, 0x200, 0x8000, 0xfc0000, 0x10000, 0x20000, 0x0, 0x7000000, 0x10087, 0x8002800, 0x87, 0x0,
        0xfc0000, 0x7000000, 0x10000, 0x8002800, };
  }
